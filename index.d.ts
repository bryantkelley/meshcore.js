...
type Message = { contactMessage: any } | { channelMessage: any } | null;
...
declare class Connection extends EventEmitter {
  ...
  sendCommandSendTracePath(tag: number, auth: number, path: Uint8Array<ArrayBuffer>): Promise<void>;
  ...
  findContactByPublicKeyPrefix(pubKeyPrefix: Uint8Array<ArrayBuffer>): Promise<Contact | undefined>;
  sendTextMessage(
...
// WebBleConnection
declare class WebBleConnection extends Connection {
...
// SerialConnection
declare class SerialConnection extends Connection {
  constructor();
...
declare class NodeJSSerialConnection extends SerialConnection {
...
// WebSerialConnection
declare class WebSerialConnection extends SerialConnection {
...
// TCPConnection
declare class TCPConnection extends Connection {
